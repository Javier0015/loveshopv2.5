  ...
  <body class="home">
    ...
    <main class="hero-section">
      <div>
        ...
        <model-viewer src="./modelos/all.gltf" alt="A 3D model of a car" class="MODEL1" shadow-intensity="1" camera-controls auto-rotate ar >
        </model-viewer>
      </div>
    ...
    <section class="product-section">
      <div class="category bg-yellow grid">
        ...
        <div class="product-img2">
          <model-viewer src="./modelos/scene2.gltf" alt="A 3D model of a car" shadow-intensity="1" camera-controls auto-rotate ar >
          </model-viewer>
        </div>
      </div>
      <div class="category bg-red grid">
        ...
        <div class="product-img3">
          <model-viewer src="./modelos/bolsa.gltf" alt="A 3D model of a car" shadow-intensity="1" camera-controls auto-rotate ar >
          </model-viewer>
        </div>
      </div>
      <div class="category bg-black grid">
        ...
        <div class="product-img4">
          <model-viewer src="./modelos/botas.gltf" alt="A 3D model of a car" shadow-intensity="1" camera-controls auto-rotate ar >
          </model-viewer>
        </div>
      </div>

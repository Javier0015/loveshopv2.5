            ...
            <div class="col-lg-5 bg-dark d-flex flex-column align-items-end min-vh-100">
                ...
                <form class="mb-5">
                    <div class="mb-4">
                      ...
                      <input type="email" required="" class="form-control  border-0" id="exampleInputEmail1" placeholder="Ingresa tu email" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-4">
                      <label for="exampleInputPassword1" class="form-label font-weight-bold">Contraseña</label>
                      <input type="password" required="" class="form-control border-0 mb-2" placeholder="Ingresa tu contraseña" id="exampleInputPassword1">
                    </div>
                ...
                <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 mt-auto w-100">
                    <p class="d-inline-block mb-0">¿Todavia no tienes una cuenta?</p> <a href="./Registro/index.html" class="text-light font-weight-bold text-decoration-none">Crea una ahora</a>
                </div>
            </div>
        </div>
      </section>
